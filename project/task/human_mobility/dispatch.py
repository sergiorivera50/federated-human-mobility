...
from project.task.human_mobility.dataset import get_dataloader_generators
from project.task.human_mobility.models import get_net
from project.task.human_mobility.train_test import get_fed_eval_fn, test, train
...
def dispatch_data(cfg: DictConfig, **kwargs: Any) -> DataStructure | None:
    ...
    if client_model_and_data is not None and partition_dir is not None:
        ...
        if client_model_and_data.upper() == "REGRESSION_RNN":
            return (
                get_net,
